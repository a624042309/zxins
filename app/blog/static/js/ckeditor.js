...
(function () {
    ...
    (function () {
        var a = [], e = CKEDITOR.env.gecko ? "-moz-" : CKEDITOR.env.webkit ? "-webkit-" : CKEDITOR.env.ie ? "-ms-" : "",
            b = /&/g, c = />/g, f = /</g, d = /"/g, h = /&amp;/g, l = /&gt;/g, i = /&lt;/g, g = /&quot;/g;
    ...
    CKEDITOR.dtd = function () {
        var a = CKEDITOR.tools.extend, e = function (a, f) {
                ...
                table: 1,
                ul: 1
            }, d = {command: 1, link: 1, meta: 1, noscript: 1, script: 1, style: 1}, h = {}, l = {"#": 1},
        ...
        CKEDITOR.tools.extend(CKEDITOR.dom.element.prototype, {
            ...
            getDocumentPosition: function (a) {
                ...
                if (document.documentElement.getBoundingClientRect) {
                    var m =
                            this.$.getBoundingClientRect(), t = e.$.documentElement, s = t.clientTop || i.$.clientTop || 0,
                        y = t.clientLeft || i.$.clientLeft || 0, p = true;
                    if (CKEDITOR.env.ie) {
    ...
    (function () {
        function a(a, b) {
            ...
            d = c.endContainer;
            var m = c.startOffset, e = c.endOffset, h, E = this.guard, k = this.type,
        ...
        var d = /^[\t\r\n ]*(?:&nbsp;|\xa0)$/, h = CKEDITOR.dom.walker.whitespaces(),
            l = CKEDITOR.dom.walker.bookmark(), i = CKEDITOR.dom.walker.temp();
    ...
    (function () {
        ...
        var J = CKEDITOR.dtd, z = 1, L = CKEDITOR.tools.copy, B = CKEDITOR.tools.trim, w = "cke-test",
            H = ["", "p", "br", "div"];
        ...
        CKEDITOR.filter.prototype = {
            allow: function (b, c, f) {
                ...
                var f = this, e = [], n = this.editor && this.editor.config.protectedSource, r, x = false,
        ...
        var C = {styles: 1, attributes: 1, classes: 1},
            ...
            F = {styles: /{([^}]+)}/, attrs: /\[([^\]]+)\]/, classes: /\(([^\)]+)\)/}, G = /^cke:(object|embed|param)$/,
            $ = /^(object|embed|param)$/, aa = CKEDITOR.filter.transformationsTools = {
        ...
        CKEDITOR.htmlParser.fragment.fromHtml =
            function (d, h, l) {
                ...
                var p = new CKEDITOR.htmlParser,
                    ...
                    j = [], u = [], v = q, E = q.name == "textarea", k = q.name == "pre";
        ...
        a.prototype = {
            add: function (a, c, f) {
                ...
                var f = c instanceof CKEDITOR.htmlParser.node || c instanceof CKEDITOR.htmlParser.fragment,
                    d = Array.prototype.slice.call(arguments, 1), e = this.rules, l = e.length, i, g, m, t;
                for (t = 0; t < l; t++) {
                    if (f) {
                        i = c.type;
                        g = c.name
    ...
    (function () {
        ...
        CKEDITOR.htmlDataProcessor = function (b) {
            ...
            b.on("toHtml", function (a) {
                var a = a.data, c = a.dataValue, d, c = q(c, b), c = m(c, B), c = g(c), c = m(c, L),
                    c = c.replace(H, "$1cke:$2"), c = c.replace(A, "<cke:$1$2></cke:$1>"),
                    c = c.replace(/(<pre\b[^>]*>)(\r\n|\n)/g, "$1$2$2"),
        ...
        var j = /(?:&nbsp;|\xa0)$/, u = "{cke_protected}", v = CKEDITOR.dtd,
            E = ["caption", "colgroup", "col", "thead", "tfoot", "tbody"],
            k = CKEDITOR.tools.extend({}, v.$blockLimit, v.$block), n = {elements: {input: l, textarea: l}}, r = {
        ...
        var D = /<(a|area|img|input|source)\b([^>]*)>/gi,
            J = /([\w-]+)\s*=\s*(?:(?:"[^"]*")|(?:'[^']*')|(?:[^ "'>]+))/gi, z = /^(href|src|name)$/i,
            L = /(?:<style(?=[ >])[^>]*>[\s\S]*?<\/style>)|(?:<(:?link|meta|base)[^>]*>)/gi,
            B = /(<textarea(?=[ >])[^>]*>)([\s\S]*?)(?:<\/textarea>)/gi, w = /<cke:encoded>([^<]*)<\/cke:encoded>/gi,
    ...
    (function () {
        ...
        CKEDITOR.editor.prototype.resize = function (a, b, d, e) {
            var l = this.container, i = this.ui.space("contents"),
    ...
    (function () {
                ...
                focus: function () {
                    ...
                    if (!this.is("textarea")) {
                        ...
                        this.attachListener(a, "key", function (b) {
                            ...
                            if (c in k) {
                                var b = a.getSelection(), f, g = b.getRanges()[0], h = g.startPath(), i, m, l,
                                    c = c == 8;
        ...
        var m = CKEDITOR.dom.walker.bogus(),
            ...
            s = CKEDITOR.dom.walker.whitespaces(true), y = CKEDITOR.dom.walker.bookmark(false, true);
    ...
    (function () {
        ...
        CKEDITOR.on("instanceCreated", function (b) {
            ...
            d.on("contentDom", function () {
                ...
                var f = d.document, g = CKEDITOR.document, k = d.editable(), i = f.getBody(),
                    n = f.getDocumentElement(), w = k.isInline(), j, C;
                    ...
                    var a = u ? function () {
                        ...
                        var b = function (b, c) {
                            ...
                            for (var e = d.children, f, g, h = b.duplicate(), k = 0, i = e.length - 1, j = -1, A, x; k <= i;) {
                                ...
                                if (A > 0) i = j - 1; else if (A < 0) k = j + 1; else return {
                                    container: d,
                                    offset: a(f)
                                }
                            }
    ...
    (function () {
        ...
        function s(a, b) {
            var c = this._.definition,
                d = c.attributes, c = c.styles, e = E(this)[a.getName()],
        ...
        var r = {
            ...
            }, o =
                {
                    ...
                    audio: 1,
                    video: 1
                }, M = /\s*(?:;\s*|$)/, D = /#\((.+?)\)/g, J = CKEDITOR.dom.walker.bookmark(0, 1),
    ...
    (function () {
        function a(a, c, e) {
            var d = a.serializable, h = c[e ? "endContainer" : "startContainer"], l = e ? "endOffset" : "startOffset",
